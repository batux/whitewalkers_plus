...
echo "********************************************************"
echo "Starting whitewalkers-user-registration-service "
echo "********************************************************"
java $MEM_ARGS -Dspring.profiles.active=$PROFILE -jar /usr/local/whitewalkers-user-registration-service/@project.build.finalName@.jar
